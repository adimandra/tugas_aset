    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Perbarui Data Aset</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
            ...
            <div class="container-fluid">
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <h3 class="card-title">Form Perbarui Aset</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('assets.updateGambar', ['id' => $aset->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf

                            <!-- Input untuk Gambar -->
                            <div class="form-group">
                                <label for="profile_picture">Upload File Aset</label>
                                <input type="file" id="profile_picture" name="profile_picture" class="form-control-file" accept="image/*" required>
                            </div>
